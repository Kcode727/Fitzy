...
export default function ImageContainer() {
  ...
  return (
    <div className="container1 w-screen h-screen bg-gray-300 flex relative">
      ...
      <div className="overlay absolute inset-0 opacity-0 flex items-center justify-center">
        <h1 className="title text-4xl text-white">Welcome</h1>
      </div>

      <div className="navbar absolute top-0 left-0 w-full p-4 opacity-0">
